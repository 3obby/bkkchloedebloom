    ...
    <div className="fixed inset-0 w-full h-full -z-10 overflow-hidden">
      ...
      <div className={`svg-placeholder ${videoLoaded || videoBackground ? 'hidden' : 'visible'}`}>
        <svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' style={{ position: 'absolute', top: 0, left: 0, zIndex: -1 }}>
          <rect fill='#D69CA2' width='540' height='450'/>
          <defs>
            <linearGradient id='a' gradientUnits='userSpaceOnUse' x1='0' x2='0' y1='0' y2='100%' gradientTransform='rotate(220,756,430)'>
              <stop offset='0' stopColor='#D69CA2'/>
              <stop offset='1' stopColor='#FEA841'/>
            </linearGradient>
            <pattern patternUnits='userSpaceOnUse' id='b' width='793' height='660.8' x='0' y='0' viewBox='0 0 1080 900'>
              <g fillOpacity='0.03'>
                ...
                <polygon fill='#222' points='180 0 90 150 270 150'/>
